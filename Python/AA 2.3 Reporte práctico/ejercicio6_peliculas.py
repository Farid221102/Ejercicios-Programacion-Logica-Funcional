...
calificaciones = [{"titulo": pelicula["Titulo"], "calificacion": pelicula["CalificaciónIMDB"]} for pelicula in peliculasXD]

calificacionesMap = list(map(lambda pelicula: {"titulo": pelicula["Titulo"],"calificacion": pelicula["CalificaciónIMDB"]}, peliculasXD))
